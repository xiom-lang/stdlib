...
17 public-type leaves are declared with **different shapes** in two or more
...
| `PHeap` | `collect/priority.xi`, `collect/heap.xi` | dedup (probability heap twin) |
