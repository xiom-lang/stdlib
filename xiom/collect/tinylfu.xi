...
pub fn cms_add(sketch: &mut CountMinSketch, key: Int)
  ensures: cms_estimate(sketch, key) >= 1
{
  var r: Int = 0;
...
pub fn cms_clear(sketch: &mut CountMinSketch)
  ensures: cms_estimate(sketch, 0) == 0
{
  var i: Int = 0;
...
pub fn tinylfu_increment(f: &mut TinyLfu, key: Int)
  ensures: tinylfu_estimate(f, key) >= 1
{
...
pub fn tinylfu_reset(f: &mut TinyLfu)
  ensures: tinylfu_estimate(f, 0) <= tinylfu_estimate(f, 0)@pre
{
  var i: Int = 0;
