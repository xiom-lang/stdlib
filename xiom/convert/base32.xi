...
// ============================================================================
// Base32 and base32hex (RFC 4648) encoding/decoding. Both encode 5 bytes of
// input as 8 characters of output using a 32-symbol alphabet, with '=' padding
// to a multiple of 8 characters. Base32 uses A-Z,2-7; base32hex uses 0-9,A-V.
// ============================================================================
